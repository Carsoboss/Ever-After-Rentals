...
export default function ProductsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Header />
      <main className="flex-1 bg-gradient-to-b from-rose-50 to-white pt-16">
        ...
        {/* Fixed CTA Button */}
        <div className="fixed bottom-24 right-8 z-40 animate-in fade-in slide-in-from-bottom-8 duration-500">
          <Link
            href="/schedule-tour"
            className={cn(
